...
pub fn create_url(
    ...
    Ok(())
    //let query_params = [params_list.as_bytes(), info_hash];
    //let parsed_as_url_encoding = reqwest::Url::parse_with_params("https://google.com", &params);
    //println!("{:?}", parsed_as_url_encoding);
}
